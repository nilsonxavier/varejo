...
<div class="container bg-white p-4 rounded shadow">
    ...
    <div class="row g-3">
        <div class="col-md-4">
            <div class="card border-primary section-card section-card">
        ...
        <div class="col-md-8">
            <div class="row g-3">
                <div class="col-md-4">
                    <div class="card text-bg-secondary section-card section-card">
                        <div class="card-body section-card section-card">
                ...
                <div class="col-md-4">
                    <div class="card text-bg-success section-card section-card">
                        <div class="card-body section-card section-card">
                ...
                <div class="col-md-4">
                    <div class="card text-bg-danger section-card section-card">
                        <div class="card-body section-card section-card">
                ...
                <div class="col-12">
                    <div class="card text-bg-primary section-card section-card">
                        <div class="card-body section-card section-card">
    ...
    <div class="table-responsive">
        <div class="table-responsive"><div class="table-responsive"><table class="table table-striped table-hover align-middle">
