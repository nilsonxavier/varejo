...
<div class="container py-4">
    <div class="section-card mb-4 section-card section-card">
    ...
    <div class="table-responsive"><div class="table-responsive"><table class="table table-bordered" id="tabelaMateriais">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Nome</th>
